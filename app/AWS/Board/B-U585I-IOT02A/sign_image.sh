...
imgtool sign --version $2 --key $(dirname $0)/../../../../bl2/root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0xA0000 --security-counter $3 --confirm --dependencies "(0,"1.6.0"+0)" $1.hex $1_signed.bin
imgtool sign --version $2 --key $(dirname $0)/../../../../bl2/root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0xA0000 --security-counter $3           --dependencies "(0,"1.6.0"+0)" $1.hex $1_ota.bin

bin2hex.py --offset 0x0807A000 $1_signed.bin $1_signed.hex
