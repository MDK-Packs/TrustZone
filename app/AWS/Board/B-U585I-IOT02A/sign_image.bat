...
imgtool sign --version %2 --key %~dp0..\..\..\..\bl2\root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0xA0000 --security-counter %3 --confirm --dependencies "(0,"1.6.0"+0)" %1.hex %1_signed.bin
imgtool sign --version %2 --key %~dp0..\..\..\..\bl2\root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0xA0000 --security-counter %3           --dependencies "(0,"1.6.0"+0)" %1.hex %1_ota.bin
