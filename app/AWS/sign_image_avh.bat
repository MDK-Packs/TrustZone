...
imgtool sign --version %2 --key ../../bl2/root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0x60000 --security-counter %3 --confirm --dependencies "(0,"1.6.0"+0)" %1 %~n1_signed.bin
imgtool sign --version %2 --key ../../bl2/root-RSA-3072_1.pem --public-key-format full --align 16 --pad --pad-header --boot-record NSPE --header-size 0x400 --slot-size 0x60000 --security-counter %3           --dependencies "(0,"1.6.0"+0)" %1 %~n1_ota.bin

bin2hex.py --offset 0x01060000 %~n1_signed.bin %~n1_signed.hex
